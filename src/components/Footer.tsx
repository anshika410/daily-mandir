...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-primary via-primary/95 to-secondary border-t-4 border-secondary shadow-2xl lotus-pattern">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 text-white/90 text-lg p-3 bg-white/10 rounded-lg">
              ...
              <div className="flex items-start space-x-3 text-white/90 text-lg p-3 bg-white/10 rounded-lg">
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-3">
                <Button size="sm" variant="outline" className="w-12 h-12 p-0 border-2 border-secondary hover:bg-secondary hover:text-primary transition-all">
